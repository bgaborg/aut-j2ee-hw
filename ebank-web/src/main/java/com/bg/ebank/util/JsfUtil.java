...
public class JsfUtil {
    private final static String MSG_HEADER = "ebank event";
    ...
    public static void addErrorMessage(String msg) {
        FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_ERROR, MSG_HEADER, msg);
    ...
    public static void addSuccessMessage(String msg) {
        FacesMessage facesMsg = new FacesMessage(FacesMessage.SEVERITY_INFO, MSG_HEADER, msg);
